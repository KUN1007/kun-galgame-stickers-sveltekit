...
这是由我个人在各种 galgame 里截的表情包，以后可能会更新一些 SD_CG 和 CG 的截图作为表情包，现在只有游戏中人物的纯表情
...
A：当然可以！如果您熟悉 github 使用方法，您可以提交 Pr 给我们，将您自己的表情放在您自己命名的文件夹内。您也可以加入下方的 galgame 交流群将表情包发在群里。
